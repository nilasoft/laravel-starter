<?php
    ...
    class UtilsTest extends TestCase {
        ...
        public function deleteFile() {
            $response = $this->postJson( route( 'resources.test.upload', [ 'field' => 'uploadAZipedFile' ] ), [
            ...
            $this->resources->deleteFile( $model->address );
            $this->assertFalse( $this->storage->exists( $model->address ) );
            $this->resources->delete( $model->id );
        }
        ...
        public function deleteAModel() {
            ...
            $secondResponse = $this->postJson( route( 'resources.test.upload', [ 'field' => 'uploadAZipedFile' ] ), [
                'uploadAZipedFile' => UploadedFile::fake()->create( 'ziped.file.zip', 10230, 'application/zip' )
            ] );
        ...
        public function batchDeleteModels() {
            ...
            $this->resources->batchDelete( [ $firstModel->id, $secondModel->id ] );
